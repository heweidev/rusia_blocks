...
public class ColorPickerDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (height > width) {
        	ColorPickerView myView = new ColorPickerView(context, (int)(height * 0.38f) , (int)(width * 0.5f));
            setContentView(myView);
        } else {
        	ColorPickerView myView = new ColorPickerView(context, (int)(height * 0.6f) , (int)(width * 0.38f));
            setContentView(myView);
        }
